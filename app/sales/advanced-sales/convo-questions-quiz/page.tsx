...
export default function ConversationLogQuiz() {
  ...
  const question = {
    text: 'What is the main purpose of asking thoughtful questions during the conversation log?',
    options: {
      a: 'To speed up the credit check process',
      b: 'To build trust and understand the customer’s real needs',
      c: 'To show off your inventory knowledge',
    },
  };

  return (
    <div className="min-h-screen bg-white text-gray-900 p-8 max-w-3xl mx-auto">
      <h1 className="text-2xl font-bold mb-6">Quiz: Asking Great Questions</h1>
      ...
      {!submitted ? (
        ...
        <div className="mt-6">
          {isCorrect ? (
            ...
            <p className="text-red-600 font-semibold">Incorrect ❌ — the correct answer is "b".</p>
          )}
        </div>
      )}
    </div>
