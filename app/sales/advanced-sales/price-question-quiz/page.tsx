...
export default function PriceQuestionQuiz() {
  ...
  const question = {
    text: 'How should you respond when a customer asks for the price too early?',
    options: {
      a: 'Tell them the cash price immediately',
      b: 'Shift the conversation to monthly payments and down payment options',
      c: 'Say “I’ll get my manager”',
    },
  };

  return (
    <div className="min-h-screen bg-white text-gray-900 p-8 max-w-3xl mx-auto">
      <h1 className="text-2xl font-bold mb-6">Quiz: Handling “What’s the Price?”</h1>
