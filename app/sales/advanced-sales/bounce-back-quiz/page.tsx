...
export default function BounceBackQuiz() {
  ...
  const question = {
    text: 'What is the purpose of the Bounce Back Close?',
    options: {
      a: 'To immediately drop the price',
      b: 'To re-engage a hesitant customer with a question that brings them back to value',
      c: 'To suggest a different vehicle',
    },
  };

  return (
    <div className="min-h-screen bg-white text-gray-900 p-8 max-w-3xl mx-auto">
      <h1 className="text-2xl font-bold mb-6">Quiz: The Bounce Back Close</h1>
